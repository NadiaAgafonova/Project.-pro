...
class Db:
    ...
    def default_data(self):
        usr = [
            (1, 'Иван Васильевич Грозный','+79254783698','grozniy@gmail.com', 68000),
            (2, 'Михаил Иванович Глинка','+79551587423','glinka@ya.ru', 53000),
            (3, 'Софья Васильевна Ковалевская','+79378935412','kovalevskaya@gmail.com', 47000),
            (4, 'Василий Владимирович Петров','+79562547896','petrov@mail.ru', 85000),
            (5, 'Павел Михайлович Голубицкий','+79501239874','holobytskiy@gmail.com', 96000)
        ]
        query_insert = '''
        INSERT INTO users (id, name,phone,email,zarplata)
        VALUES (?, ?, ?, ?, ?)
        '''
